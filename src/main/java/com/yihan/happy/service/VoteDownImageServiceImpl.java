 ...
 */
@ServiceConfig(
        actionName = ActionNames.VOTE_DOWN_IMAGE,
        requestConfigs = {
    ...
    @ResponseState(state = "SUCCESS", desc = "操作成功")
        ...
        desc = "图片点踩")
public class VoteDownImageServiceImpl implements Service {
    ...
    public void execute(MessageContext messageContext) {
        ...
        long voteDown = this.jokeImageLocalService.voteDownImage(id);
